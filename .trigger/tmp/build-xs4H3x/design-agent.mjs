import {
  ...
  generateText,
  tool
} from "./chunk-SZITL24C.mjs";
import "./chunk-6EKE4B5Z.mjs";
import {
  external_exports,
  task
...
__name(isTextStorageNode, "isTextStorageNode");
function isFileStorageNode(node) {
  return node[1].type === CrdtType.FILE;
}
__name(isFileStorageNode, "isFileStorageNode");
...
__name(toUpdateSource, "toUpdateSource");
...
function createManagedPool(options2) {
  ...
  return {
    ...
    dispatch(ops, reverse, storageUpdates, options22) {
      onDispatch?.(ops, reverse, storageUpdates, options22);
    },
...
var AbstractCrdt = class {
  ...
  constructor() {
    Object.defineProperty(this, kInternal, {
      value: {
        getId: /* @__PURE__ */ __name(() => this.#id, "getId")
      },
      enumerable: false
    });
  }
...
__name(getLiveFileId, "getLiveFileId");
var LiveFile = class _LiveFile extends AbstractCrdt {
  static {
    __name(this, "_LiveFile");
  }
  #data;
  constructor(data) {
    super();
...
__name(createStorageFileId, "createStorageFileId");
...
__name(attributesEqual, "attributesEqual");
function cloneAttributes(attributes) {
  return attributes === void 0 ? void 0 : freeze({ ...attributes });
}
__name(cloneAttributes, "cloneAttributes");
...
__name(splitSegmentsAt, "splitSegmentsAt");
...
__name(clipIndexToCodePointBoundary, "clipIndexToCodePointBoundary");
...
__name(clipRangeToCodePointBoundaries, "clipRangeToCodePointBoundaries");
...
__name(applyInsert, "applyInsert");
...
__name(extractDeletedSegments, "extractDeletedSegments");
...
__name(applyDelete, "applyDelete");
...
__name(formatReverseOperations, "formatReverseOperations");
...
__name(mapIndexThroughOperation, "mapIndexThroughOperation");
...
__name(mapTextIndexThroughOperations, "mapTextIndexThroughOperations");
...
__name(inverseMapIndexThroughOperation, "inverseMapIndexThroughOperation");
...
__name(inverseMapTextIndexThroughOperations, "inverseMapTextIndexThroughOperations");
function oppositeOrder(order) {
  return order === "before" ? "after" : "before";
}
__name(oppositeOrder, "oppositeOrder");
...
__name(mapIndexOverDelete, "mapIndexOverDelete");
...
__name(transformInsert, "transformInsert");
...
__name(transformDelete, "transformDelete");
...
__name(transformFormat, "transformFormat");
...
__name(transformSingle, "transformSingle");
...
__name(applyTextOperationsToSegments, "applyTextOperationsToSegments");
...
var LiveText = class _LiveText extends AbstractCrdt {
  ...
  constructor(textOrData = "", version = 0) {
    ...
    Object.assign(this[kInternal], {
      encodeIndex: /* @__PURE__ */ __name((localIndex) => this.#encodeIndex(localIndex), "encodeIndex"),
      decodeIndex: /* @__PURE__ */ __name((index, fromVersion) => this.#decodeIndex(index, fromVersion), "decodeIndex")
    });
  }
  get version() {
    return this.#version;
...
async function fetchPolyfill() {
  return typeof globalThis.fetch !== "undefined" ? globalThis.fetch : (await import("./lib-5JZD77UX.mjs")).default;
}
...
var ROOM_FILE_PART_SIZE2 = 5 * 1024 * 1024;
...
async function uploadRoomFile({
  ...
  const handleRetryError = /* @__PURE__ */ __name((err) => {
    ...
    return err instanceof LiveblocksError2 && err.status >= 400 && err.status < 500;
  }, "handleRetryError");
  if (file.size <= ROOM_FILE_PART_SIZE2) {
    return autoRetry(
      uploadSingle,
  ...
  const abortPartUploads = /* @__PURE__ */ __name((reason) => {
    partUploadController.abort(reason);
  }, "abortPartUploads");
  const handleExternalAbort = /* @__PURE__ */ __name(() => abortPartUploads(), "handleExternalAbort");
  if (signal?.aborted) {
    handleExternalAbort();
  } else {
...
__name(uploadRoomFile, "uploadRoomFile");
function splitRoomFileIntoParts(file) {
  const parts = [];
  let start = 0;
  while (start < file.size) {
    const end = Math.min(start + ROOM_FILE_PART_SIZE2, file.size);
    parts.push({
...
__name(splitRoomFileIntoParts, "splitRoomFileIntoParts");
...
var Liveblocks = class {
  ...
  async #post(path, json, options2, params) {
  ...
  async #putBlob(path, body, params, options2) {
    const url3 = urljoin(this.#baseUrl, path, params);
    const headers = {
      Authorization: `Bearer ${this.#secret}`,
      "Content-Type": "application/octet-stream"
   ...
   */
  async uploadAttachment(params, options2) {
    ...
    return await uploadRoomFile({
      ...
      uploadSingle: /* @__PURE__ */ __name(async () => {
      ...
      createMultipartUpload: /* @__PURE__ */ __name(async () => {
        const res = await this.#post(
      ...
      uploadMultipartPart: /* @__PURE__ */ __name(async (uploadId, partNumber, part, signal) => {
        const res = await this.#putBlob(
      ...
      completeMultipartUpload: /* @__PURE__ */ __name(async (uploadId, parts) => {
        const res = await this.#post(
      ...
      abortMultipartUpload: /* @__PURE__ */ __name(async (uploadId) => {
        const res = await this.#delete(
  ...
  async uploadFile(params, options2) {
  ...
  async getFileUrl(params, options2) {
    const { roomId, file } = params;
